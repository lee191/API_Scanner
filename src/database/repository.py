    ...
    def save_scan_result(
        ...
        for ep in scan_result.endpoints:
            ...
            endpoint = Endpoint(
                ...
                request_headers=getattr(ep, 'request_headers', None),
                request_body=getattr(ep, 'request_body', None),
                response_headers=getattr(ep, 'response_headers', None),
                response_body=getattr(ep, 'response_body', None),
                response_time=getattr(ep, 'response_time', None),
